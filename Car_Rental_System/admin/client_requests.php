		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					<!-- Box Head -->
					<div class="box-head">
						<h2 class="left">Respuesta cliente</h2>
						<div class="right">
							<label>Buscar</label>
					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td><a href="javascript:sureToApprove(<?php echo $row['client_id'];?>)" class="ico del">Aceptar</a><a href="#" class="ico edit">Borrar</a></td>
							</tr>
							<?php
								}
							?>
