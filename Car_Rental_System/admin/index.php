...
<head>
	...
	<script type="text/javascript">
		function sureToApprove(id){
			if(confirm("¿Seguro que quiere borrar este mensaje?")){
		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					<!-- Box Head -->
					<div class="box-head">
						<h2 class="left">Mensajes de Clientes</h2>
						<div class="right">
							<label>Buscar mensajes</label>
					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<th>Hora de envío</th>
								<th>Estado</th>
								<th width="110" class="ac">Acción</th>
							</tr>
							<?php
							...
							<tr>
								...
								<td><a href="javascript:sureToApprove(<?php echo $row['msg_id'];?>)" class="ico del">Borrar</a><a href="#" class="ico edit">Editar</a></td>
							</tr>
							<?php
								}
							?>
			...
			<div id="sidebar">
				...
				<div class="box">
					...
					<div class="box-content">
						<a href="#" class="add-button"><span>Enviar Mensajes</span></a>
						<div class="cl">&nbsp;</div>
